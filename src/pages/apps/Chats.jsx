    ...
    <>
      ...
      <div className="row">
        <div className="col-md-12">
          <Button variant="btn btn-secondary py-3 mb-4 text-center d-md-none"><i className="mdi mdi-menu me-0 icon-md"></i></Button>
          <div className="card chat-app-wrapper">
            <div className="row mx-0">
              <div className={`col-xl-3 col-md-4 chat-list-wrapper px-0`}>
                ...
                <div className="chat-list-item-wrapper">
                  <div className="list-item">
                    <div className="profile-image">
                      ...
                      <img className="img-sm rounded-circle" src="/images/faces/face1.jpg" alt="profile" />
                    </div>
                  ...
                  <div className="list-item">
                    <div className="profile-image">
                      ...
                      <img className="img-sm rounded-circle" src="/images/faces/face5.jpg" alt="profile" />
                    </div>
                  ...
                  <div className="list-item">
                    <div className="profile-image">
                      <div className="dot-indicator sm bg-primary"></div>
                      <img className="img-sm rounded-circle" src="/images/faces/face2.jpg" alt="profile" />
                    </div>
                  ...
                  <div className="list-item">
                    <div className="profile-image">
                      ...
                      <img className="img-sm rounded-circle" src="/images/faces/face10.jpg" alt="profile" />
                    </div>
                  ...
                  <div className="list-item">
                    <div className="profile-image">
                      <img className="img-sm rounded-circle" src="/images/faces/face7.jpg" alt="profile" />
                    </div>
                ...
                <div className="sidebar-spacer d-grid gap-2">
                  <button className="btn btn-gradient-success py-3" type="button">+ New Chat</button>
                </div>
              </div>
                ...
                <div className="chat-container-wrapper">
                  <div className="chat-bubble incoming-chat">
                    ...
                    <div className="sender-details">
                      <img className="sender-avatar img-xs rounded-circle" src="/images/faces/face2.jpg" alt="profile" />
                      <p className="seen-text">Message seen : 20 min ago</p>
                    </div>
                  </div>
                  <div className="chat-bubble outgoing-chat">
                    <div className="chat-message">
                      <p className="fw-bold">Frank Carter</p>
                      <p>Leo duis ut diam quam nulla porttitor massa id neque. Sed enim ut sem</p>
                    </div>
                    <div className="sender-details">
                      <img className="sender-avatar img-xs rounded-circle" src="/images/faces/face3.jpg" alt="profile" />
                  ...
                  <div className="chat-bubble outgoing-chat">
                    <div className="chat-message">
                      <p className="fw-bold">Frank Carter</p>
                      <p>Leo duis ut diam quam nulla porttitor massa id neque. Sed enim ut sem</p>
                      <p className="fw-medium"><i className="mdi mdi-paperclip me-2"></i>workfile.pdf</p>
                    </div>
                    <div className="sender-details">
                      <img className="sender-avatar img-xs rounded-circle" src="/images/faces/face3.jpg" alt="profile" />
                      <p className="seen-text">Message seen : 10 min ago</p>
              ...
              <div className="col-xl-3 d-none d-lg-block px-0 chat-sidebar">
                <img className="img-fluid w-100" src="/images/chat/profile_image.jpg" alt="profile" />
                <div className="px-4">
                  <div className="d-flex pt-4">
                    <div className="wrapper">
                      <h5 className="fw-medium mb-0 ellipsis">Cecelia Benson</h5>
                      <p className="mb-0 text-muted ellipsis">General manager</p>
                    </div>
                    <div className="badge badge-gradient-success mb-auto ms-auto">Online</div>
                  </div>
                  <div className="pt-3">
                    <div className="d-flex align-items-center py-1">
                      <i className="mdi mdi-whatsapp me-2"></i>
                      <p className="mb-0 fw-medium">225-248-4861</p>
                    </div>
                    <div className="d-flex align-items-center py-1">
                      <i className="mdi mdi-email-outline me-2"></i>
                      <p className="mb-0 fw-medium ellipsis">cecilia.tromp@danny.com</p>
                    </div>
                    <div className="d-flex align-items-center py-1">
                      <i className="mdi mdi-map-marker-outline me-2"></i>
                      <p className="mb-0 fw-medium ellipsis">United Kingdom</p>
                    </div>
                  </div>
                  <div className="list-item">
                    ...
                    <div className="wrapper ps-3">
                      <h5 className="fw-medium mb-0">$2300</h5>
                  ...
                  <div className="list-item border-bottom-0">
                    ...
                    <div className="wrapper ps-3 w-100">
                      ...
                      <div className="d-flex">
                        <p className="text-muted mb-0">Deposit</p>
                        <p className="fw-bold ms-auto">4.7 GB free</p>
                      </div>
                    </div>
                  </div>
                  <h5 className="fw-medium mt-3">Documentation</h5>
                  <div className="list-item">
                    <div className="d-flex align-items-center justify-content-center img-sm badge-gradient-primary">
                      <i className="mdi mdi-file-pdf-box icon-sm"></i></div>
                    <div className="wrapper ps-3 w-100">
                      <h5 className="fw-medium mb-0 ellipsis">Company Profile.pdf</h5>
                      <div className="d-flex">
                  ...
                  <div className="list-item">
                    <div className="d-flex align-items-center justify-content-center img-sm badge-gradient-primary">
                      <i className="mdi mdi-file-pdf-box icon-sm"></i></div>
                    <div className="wrapper ps-3 w-100">
                      <h5 className="fw-medium mb-0 ellipsis">Proposal.pdf</h5>
                      <div className="d-flex">
                  ...
                  <h5 className="fw-medium mt-5 mb-4">Share photos</h5>
                  <div className="row">
                    <div className="col-4">
                      <img className="w-100 img-fluid rounded" src="/images/chat/thumb_image1.jpg" alt="thumb" />
                    </div>
                    <div className="col-4">
                      <img className="w-100 img-fluid rounded" src="/images/chat/thumb_image2.jpg" alt="thumb" />
                    </div>
                    <div className="col-4">
                      <img className="w-100 img-fluid rounded" src="/images/chat/thumb_image3.jpg" alt="thumb" />
                    </div>
                  </div>
                  <div className="row my-4">
                    <div className="col-4">
                      <img className="w-100 img-fluid rounded" src="/images/chat/thumb_image4.jpg" alt="thumb" />
                    </div>
                    <div className="col-4">
                      <img className="w-100 img-fluid rounded" src="/images/chat/thumb_image5.jpg" alt="thumb" />
                    </div>
                    <div className="col-4">
                      <img className="w-100 img-fluid rounded" src="/images/chat/thumb_image6.jpg" alt="thumb" />
                    </div>
                  </div>
                  <div className="row mb-4">
                    <div className="col-4">
                      <img className="w-100 img-fluid rounded" src="/images/chat/thumb_image7.jpg" alt="thumb" />
                    </div>
                    <div className="col-4">
                      <img className="w-100 img-fluid rounded" src="/images/chat/thumb_image8.jpg" alt="thumb" />
                    </div>
                    <div className="col-4">
                      <img className="w-100 img-fluid rounded" src="/images/chat/thumb_image4.jpg" alt="thumb" />
                    </div>
