            ...
            <div className="card px-2">
              <div className="card-body">
                ...
                <div className="container-fluid w-100">
                  <a href="!#" onClick={event => event.preventDefault()} className="btn btn-primary float-end mt-4 ms-2"><i className="mdi mdi-printer me-1"></i>Print</a>
                  <a href="!#" onClick={event => event.preventDefault()} className="btn btn-success float-end mt-4"><i className="mdi mdi-send me-1"></i>Send Invoice</a>
                </div>
              </div>
            </div>
          </div>
