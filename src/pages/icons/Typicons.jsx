  ...
  return (
    <div>
      <div className="page-header">
        <h3 className="page-title">Typicons</h3>
            ...
            <div class="card-body">
              <div class="row icons-list">
                <div class="col-sm-12 col-md-6 col-lg-4">
                  <i class="typcn typcn-chart-pie-outline"></i> typcn
                ...
                <div class="col-sm-12 col-md-6 col-lg-4">
                  <i class="typcn typcn-chevron-left"></i> typcn
                  typcn-chevron-left
                </div>
                <div class="col-sm-12 col-md-6 col-lg-4">
                ...
                <div class="col-sm-12 col-md-6 col-lg-4">
                  <i class="typcn typcn-chevron-right"></i> typcn
                  typcn-chevron-right
                </div>
                <div class="col-sm-12 col-md-6 col-lg-4">
                ...
                <div class="col-sm-12 col-md-6 col-lg-4">
                  <i class="typcn typcn-cloud-storage"></i> typcn
                  typcn-cloud-storage
                </div>
                <div class="col-sm-12 col-md-6 col-lg-4">
                ...
                <div class="col-sm-12 col-md-6 col-lg-4">
                  <i class="typcn typcn-code-outline"></i> typcn
                  typcn-code-outline
                </div>
                <div class="col-sm-12 col-md-6 col-lg-4">
                ...
                <div class="col-sm-12 col-md-6 col-lg-4">
                  <i class="typcn typcn-credit-card"></i> typcn
                  typcn-credit-card
                </div>
                <div class="col-sm-12 col-md-6 col-lg-4">
                ...
                <div class="col-sm-12 col-md-6 col-lg-4">
                  <i class="typcn typcn-delete-outline"></i> typcn
                ...
                <div class="col-sm-12 col-md-6 col-lg-4">
                  <i class="typcn typcn-device-desktop"></i> typcn
                  typcn-device-desktop
                </div>
                <div class="col-sm-12 col-md-6 col-lg-4">
                  <i class="typcn typcn-device-laptop"></i> typcn
                  typcn-device-laptop
                </div>
                <div class="col-sm-12 col-md-6 col-lg-4">
                  <i class="typcn typcn-device-phone"></i> typcn
                  typcn-device-phone
                </div>
                <div class="col-sm-12 col-md-6 col-lg-4">
                  <i class="typcn typcn-device-tablet"></i> typcn
                  typcn-device-tablet
                </div>
                <div class="col-sm-12 col-md-6 col-lg-4">
                ...
                <div class="col-sm-12 col-md-6 col-lg-4">
                  <i class="typcn typcn-divide-outline"></i> typcn
                ...
                <div class="col-sm-12 col-md-6 col-lg-4">
                  <i class="typcn typcn-document-add"></i> typcn
                  typcn-document-add
                </div>
                <div class="col-sm-12 col-md-6 col-lg-4">
                  <i class="typcn typcn-document-delete"></i> typcn
                  typcn-document-delete
                </div>
                <div class="col-sm-12 col-md-6 col-lg-4">
                  <i class="typcn typcn-document-text"></i> typcn
                  typcn-document-text
                </div>
                <div class="col-sm-12 col-md-6 col-lg-4">
                ...
                <div class="col-sm-12 col-md-6 col-lg-4">
                  <i class="typcn typcn-download-outline"></i> typcn
                ...
                <div class="col-sm-12 col-md-6 col-lg-4">
                  <i class="typcn typcn-eject-outline"></i> typcn
                  typcn-eject-outline
                </div>
                <div class="col-sm-12 col-md-6 col-lg-4">
                ...
                <div class="col-sm-12 col-md-6 col-lg-4">
                  <i class="typcn typcn-equals-outline"></i> typcn
                ...
                <div class="col-sm-12 col-md-6 col-lg-4">
                  <i class="typcn typcn-export-outline"></i> typcn
                ...
                <div class="col-sm-12 col-md-6 col-lg-4">
                  <i class="typcn typcn-eye-outline"></i> typcn
                  typcn-eye-outline
                </div>
                <div class="col-sm-12 col-md-6 col-lg-4">
                ...
                <div class="col-sm-12 col-md-6 col-lg-4">
                  <i class="typcn typcn-flag-outline"></i> typcn
                  typcn-flag-outline
                </div>
                <div class="col-sm-12 col-md-6 col-lg-4">
                ...
                <div class="col-sm-12 col-md-6 col-lg-4">
                  <i class="typcn typcn-flash-outline"></i> typcn
                  typcn-flash-outline
                </div>
                <div class="col-sm-12 col-md-6 col-lg-4">
                ...
                <div class="col-sm-12 col-md-6 col-lg-4">
                  <i class="typcn typcn-flow-children"></i> typcn
                  typcn-flow-children
                </div>
                <div class="col-sm-12 col-md-6 col-lg-4">
                ...
                <div class="col-sm-12 col-md-6 col-lg-4">
                  <i class="typcn typcn-flow-parallel"></i> typcn
                  typcn-flow-parallel
                </div>
                <div class="col-sm-12 col-md-6 col-lg-4">
                  <i class="typcn typcn-flow-switch"></i> typcn
                  typcn-flow-switch
                </div>
                <div class="col-sm-12 col-md-6 col-lg-4">
                ...
                <div class="col-sm-12 col-md-6 col-lg-4">
                  <i class="typcn typcn-folder-delete"></i> typcn
                  typcn-folder-delete
                </div>
                <div class="col-sm-12 col-md-6 col-lg-4">
                  <i class="typcn typcn-folder-open"></i> typcn
                  typcn-folder-open
                </div>
                <div class="col-sm-12 col-md-6 col-lg-4">
                ...
                <div class="col-sm-12 col-md-6 col-lg-4">
                  <i class="typcn typcn-globe-outline"></i> typcn
                  typcn-globe-outline
                </div>
                <div class="col-sm-12 col-md-6 col-lg-4">
                ...
                <div class="col-sm-12 col-md-6 col-lg-4">
                  <i class="typcn typcn-group-outline"></i> typcn
                  typcn-group-outline
                </div>
                <div class="col-sm-12 col-md-6 col-lg-4">
                ...
                <div class="col-sm-12 col-md-6 col-lg-4">
                  <i class="typcn typcn-heart-outline"></i> typcn
                  typcn-heart-outline
                </div>
                <div class="col-sm-12 col-md-6 col-lg-4">
                ...
                <div class="col-sm-12 col-md-6 col-lg-4">
                  <i class="typcn typcn-home-outline"></i> typcn
                  typcn-home-outline
                </div>
                <div class="col-sm-12 col-md-6 col-lg-4">
                ...
                <div class="col-sm-12 col-md-6 col-lg-4">
                  <i class="typcn typcn-image-outline"></i> typcn
                  typcn-image-outline
                </div>
                <div class="col-sm-12 col-md-6 col-lg-4">
                ...
                <div class="col-sm-12 col-md-6 col-lg-4">
                  <i class="typcn typcn-infinity-outline"></i> typcn
                ...
                <div class="col-sm-12 col-md-6 col-lg-4">
                  <i class="typcn typcn-info-large mx-0"></i> typcn
                  typcn-info-large
                </div>
                <div class="col-sm-12 col-md-6 col-lg-4">
                  <i class="typcn typcn-info-outline"></i> typcn
                  typcn-info-outline
                </div>
                <div class="col-sm-12 col-md-6 col-lg-4">
                ...
                <div class="col-sm-12 col-md-6 col-lg-4">
                  <i class="typcn typcn-input-checked"></i> typcn
                  typcn-input-checked
                </div>
                <div class="col-sm-12 col-md-6 col-lg-4">
                  <i class="typcn typcn-key-outline"></i> typcn
                  typcn-key-outline
                </div>
                <div class="col-sm-12 col-md-6 col-lg-4">
                ...
                <div class="col-sm-12 col-md-6 col-lg-4">
                  <i class="typcn typcn-link-outline"></i> typcn
                  typcn-link-outline
                </div>
                <div class="col-sm-12 col-md-6 col-lg-4">
                ...
                <div class="col-sm-12 col-md-6 col-lg-4">
                  <i class="typcn typcn-location-arrow"></i> typcn
                  typcn-location-arrow
                </div>
                <div class="col-sm-12 col-md-6 col-lg-4">
                  <i class="typcn typcn-location-outline"></i> typcn
                ...
                <div class="col-sm-12 col-md-6 col-lg-4">
                  <i class="typcn typcn-lock-closed"></i> typcn
                  typcn-lock-closed
                </div>
                <div class="col-sm-12 col-md-6 col-lg-4">
                  <i class="typcn typcn-lock-open-outline"></i> typcn
                ...
                <div class="col-sm-12 col-md-6 col-lg-4">
                  <i class="typcn typcn-media-eject"></i> typcn
                  typcn-media-eject
                </div>
                <div class="col-sm-12 col-md-6 col-lg-4">
                ...
                <div class="col-sm-12 col-md-6 col-lg-4">
                  <i class="typcn typcn-media-pause"></i> typcn
                  typcn-media-pause
                </div>
                <div class="col-sm-12 col-md-6 col-lg-4">
                ...
                <div class="col-sm-12 col-md-6 col-lg-4">
                  <i class="typcn typcn-media-record"></i> typcn
                  typcn-media-record
                </div>
                <div class="col-sm-12 col-md-6 col-lg-4">
                ...
                <div class="col-sm-12 col-md-6 col-lg-4">
                  <i class="typcn typcn-media-rewind"></i> typcn
                  typcn-media-rewind
                </div>
                <div class="col-sm-12 col-md-6 col-lg-4">
                ...
                <div class="col-sm-12 col-md-6 col-lg-4">
                  <i class="typcn typcn-message-typing"></i> typcn
                ...
                <div class="col-sm-12 col-md-6 col-lg-4">
                  <i class="typcn typcn-minus-outline"></i> typcn
                  typcn-minus-outline
                </div>
                <div class="col-sm-12 col-md-6 col-lg-4">
                ...
                <div class="col-sm-12 col-md-6 col-lg-4">
                  <i class="typcn typcn-mortar-board"></i> typcn
                  typcn-mortar-board
                </div>
                <div class="col-sm-12 col-md-6 col-lg-4">
                ...
                <div class="col-sm-12 col-md-6 col-lg-4">
                  <i class="typcn typcn-notes-outline"></i> typcn
                  typcn-notes-outline
                </div>
                <div class="col-sm-12 col-md-6 col-lg-4">
                ...
                <div class="col-sm-12 col-md-6 col-lg-4">
                  <i class="typcn typcn-phone-outline"></i> typcn
                  typcn-phone-outline
                </div>
                <div class="col-sm-12 col-md-6 col-lg-4">
                ...
                <div class="col-sm-12 col-md-6 col-lg-4">
                  <i class="typcn typcn-pin-outline"></i> typcn
                  typcn-pin-outline
                </div>
                <div class="col-sm-12 col-md-6 col-lg-4">
                ...
                <div class="col-sm-12 col-md-6 col-lg-4">
                  <i class="typcn typcn-plane-outline"></i> typcn
                  typcn-plane-outline
                </div>
                <div class="col-sm-12 col-md-6 col-lg-4">
                ...
                <div class="col-sm-12 col-md-6 col-lg-4">
                  <i class="typcn typcn-plus-outline"></i> typcn
                  typcn-plus-outline
                </div>
                <div class="col-sm-12 col-md-6 col-lg-4">
                ...
                <div class="col-sm-12 col-md-6 col-lg-4">
                  <i class="typcn typcn-point-of-interest"></i> typcn
                  typcn-point-of-interest
                </div>
                <div class="col-sm-12 col-md-6 col-lg-4">
                  <i class="typcn typcn-power-outline"></i> typcn
                  typcn-power-outline
                </div>
                <div class="col-sm-12 col-md-6 col-lg-4">
                ...
                <div class="col-sm-12 col-md-6 col-lg-4">
                  <i class="typcn typcn-puzzle-outline"></i> typcn
                ...
                <div class="col-sm-12 col-md-6 col-lg-4">
                  <i class="typcn typcn-radar-outline"></i> typcn
                  typcn-radar-outline
                </div>
                <div class="col-sm-12 col-md-6 col-lg-4">
                ...
                <div class="col-sm-12 col-md-6 col-lg-4">
                  <i class="typcn typcn-refresh-outline"></i> typcn
                ...
                <div class="col-sm-12 col-md-6 col-lg-4">
                  <i class="typcn typcn-rss-outline"></i> typcn
                  typcn-rss-outline
                </div>
                <div class="col-sm-12 col-md-6 col-lg-4">
                ...
                <div class="col-sm-12 col-md-6 col-lg-4">
                  <i class="typcn typcn-scissors-outline"></i> typcn
                ...
                <div class="col-sm-12 col-md-6 col-lg-4">
                  <i class="typcn typcn-shopping-bag"></i> typcn
                  typcn-shopping-bag
                </div>
                <div class="col-sm-12 col-md-6 col-lg-4">
                  <i class="typcn typcn-shopping-cart"></i> typcn
                  typcn-shopping-cart
                </div>
                <div class="col-sm-12 col-md-6 col-lg-4">
                ...
                <div class="col-sm-12 col-md-6 col-lg-4">
                  <i class="typcn typcn-social-dribbble"></i> typcn
                ...
                <div class="col-sm-12 col-md-6 col-lg-4">
                  <i class="typcn typcn-social-facebook"></i> typcn
                ...
                <div class="col-sm-12 col-md-6 col-lg-4">
                  <i class="typcn typcn-social-flickr"></i> typcn
                  typcn-social-flickr
                </div>
                <div class="col-sm-12 col-md-6 col-lg-4">
                ...
                <div class="col-sm-12 col-md-6 col-lg-4">
                  <i class="typcn typcn-social-github"></i> typcn
                  typcn-social-github
                </div>
                <div class="col-sm-12 col-md-6 col-lg-4">
                ...
                <div class="col-sm-12 col-md-6 col-lg-4">
                  <i class="typcn typcn-social-instagram"></i> typcn
                ...
                <div class="col-sm-12 col-md-6 col-lg-4">
                  <i class="typcn typcn-social-last-fm"></i> typcn
                ...
                <div class="col-sm-12 col-md-6 col-lg-4">
                  <i class="typcn typcn-social-linkedin"></i> typcn
                ...
                <div class="col-sm-12 col-md-6 col-lg-4">
                  <i class="typcn typcn-social-pinterest"></i> typcn
                ...
                <div class="col-sm-12 col-md-6 col-lg-4">
                  <i class="typcn typcn-social-skype"></i> typcn
                  typcn-social-skype
                </div>
                <div class="col-sm-12 col-md-6 col-lg-4">
                ...
                <div class="col-sm-12 col-md-6 col-lg-4">
                  <i class="typcn typcn-social-tumbler"></i> typcn
                ...
                <div class="col-sm-12 col-md-6 col-lg-4">
                  <i class="typcn typcn-social-twitter"></i> typcn
                ...
                <div class="col-sm-12 col-md-6 col-lg-4">
                  <i class="typcn typcn-social-vimeo"></i> typcn
                  typcn-social-vimeo
                </div>
                <div class="col-sm-12 col-md-6 col-lg-4">
                ...
                <div class="col-sm-12 col-md-6 col-lg-4">
                  <i class="typcn typcn-social-youtube"></i> typcn
                ...
                <div class="col-sm-12 col-md-6 col-lg-4">
                  <i class="typcn typcn-sort-numerically"></i> typcn
                  typcn-sort-numerically
                </div>
                <div class="col-sm-12 col-md-6 col-lg-4">
                  <i class="typcn typcn-spanner-outline"></i> typcn
                ...
                <div class="col-sm-12 col-md-6 col-lg-4">
                  <i class="typcn typcn-star-full-outline"></i> typcn
                  typcn-star-full-outline
                </div>
                <div class="col-sm-12 col-md-6 col-lg-4">
                  <i class="typcn typcn-star-half-outline"></i> typcn
                ...
                <div class="col-sm-12 col-md-6 col-lg-4">
                  <i class="typcn typcn-star-outline"></i> typcn
                  typcn-star-outline
                </div>
                <div class="col-sm-12 col-md-6 col-lg-4">
                ...
                <div class="col-sm-12 col-md-6 col-lg-4">
                  <i class="typcn typcn-starburst-outline"></i> typcn
                ...
                <div class="col-sm-12 col-md-6 col-lg-4">
                  <i class="typcn typcn-tabs-outline"></i> typcn
                  typcn-tabs-outline
                </div>
                <div class="col-sm-12 col-md-6 col-lg-4">
                ...
                <div class="col-sm-12 col-md-6 col-lg-4">
                  <i class="typcn typcn-th-large-outline"></i> typcn
                ...
                <div class="col-sm-12 col-md-6 col-lg-4">
                  <i class="typcn typcn-th-list-outline"></i> typcn
                ...
                <div class="col-sm-12 col-md-6 col-lg-4">
                  <i class="typcn typcn-th-menu-outline"></i> typcn
                ...
                <div class="col-sm-12 col-md-6 col-lg-4">
                  <i class="typcn typcn-th-small-outline"></i> typcn
                ...
                <div class="col-sm-12 col-md-6 col-lg-4">
                  <i class="typcn typcn-thermometer"></i> typcn
                  typcn-thermometer
                </div>
                <div class="col-sm-12 col-md-6 col-lg-4">
                  <i class="typcn typcn-thumbs-down"></i> typcn
                  typcn-thumbs-down
                </div>
                <div class="col-sm-12 col-md-6 col-lg-4">
                ...
                <div class="col-sm-12 col-md-6 col-lg-4">
                  <i class="typcn typcn-tick-outline"></i> typcn
                  typcn-tick-outline
                </div>
                <div class="col-sm-12 col-md-6 col-lg-4">
                ...
                <div class="col-sm-12 col-md-6 col-lg-4">
                  <i class="typcn typcn-times-outline"></i> typcn
                  typcn-times-outline
                </div>
                <div class="col-sm-12 col-md-6 col-lg-4">
                ...
                <div class="col-sm-12 col-md-6 col-lg-4">
                  <i class="typcn typcn-upload-outline"></i> typcn
                ...
                <div class="col-sm-12 col-md-6 col-lg-4">
                  <i class="typcn typcn-user-add-outline"></i> typcn
                ...
                <div class="col-sm-12 col-md-6 col-lg-4">
                  <i class="typcn typcn-user-delete"></i> typcn
                  typcn-user-delete
                </div>
                <div class="col-sm-12 col-md-6 col-lg-4">
                  <i class="typcn typcn-user-outline"></i> typcn
                  typcn-user-outline
                </div>
                <div class="col-sm-12 col-md-6 col-lg-4">
                ...
                <div class="col-sm-12 col-md-6 col-lg-4">
                  <i class="typcn typcn-vendor-android"></i> typcn
                  typcn-vendor-android
                </div>
                <div class="col-sm-12 col-md-6 col-lg-4">
                  <i class="typcn typcn-vendor-apple"></i> typcn
                  typcn-vendor-apple
                </div>
                <div class="col-sm-12 col-md-6 col-lg-4">
                  <i class="typcn typcn-vendor-microsoft"></i> typcn
                  typcn-vendor-microsoft
                </div>
                <div class="col-sm-12 col-md-6 col-lg-4">
                  <i class="typcn typcn-video-outline"></i> typcn
                  typcn-video-outline
                </div>
                <div class="col-sm-12 col-md-6 col-lg-4">
                ...
                <div class="col-sm-12 col-md-6 col-lg-4">
                  <i class="typcn typcn-volume-down"></i> typcn
                  typcn-volume-down
                </div>
                <div class="col-sm-12 col-md-6 col-lg-4">
                  <i class="typcn typcn-volume-mute"></i> typcn
                  typcn-volume-mute
                </div>
                <div class="col-sm-12 col-md-6 col-lg-4">
                ...
                <div class="col-sm-12 col-md-6 col-lg-4">
                  <i class="typcn typcn-warning-outline"></i> typcn
                ...
                <div class="col-sm-12 col-md-6 col-lg-4">
                  <i class="typcn typcn-waves-outline"></i> typcn
                  typcn-waves-outline
                </div>
                <div class="col-sm-12 col-md-6 col-lg-4">
                ...
                <div class="col-sm-12 col-md-6 col-lg-4">
                  <i class="typcn typcn-weather-cloudy"></i> typcn
                  typcn-weather-cloudy
                </div>
                <div class="col-sm-12 col-md-6 col-lg-4">
                  <i class="typcn typcn-weather-downpour"></i> typcn
                  typcn-weather-downpour
                </div>
                <div class="col-sm-12 col-md-6 col-lg-4">
                  <i class="typcn typcn-weather-night"></i> typcn
                  typcn-weather-night
                </div>
                <div class="col-sm-12 col-md-6 col-lg-4">
                ...
                <div class="col-sm-12 col-md-6 col-lg-4">
                  <i class="typcn typcn-weather-shower"></i> typcn
                  typcn-weather-shower
                </div>
                <div class="col-sm-12 col-md-6 col-lg-4">
                  <i class="typcn typcn-weather-snow"></i> typcn
                  typcn-weather-snow
                </div>
                <div class="col-sm-12 col-md-6 col-lg-4">
                  <i class="typcn typcn-weather-stormy"></i> typcn
                  typcn-weather-stormy
                </div>
                <div class="col-sm-12 col-md-6 col-lg-4">
                  <i class="typcn typcn-weather-sunny"></i> typcn
                  typcn-weather-sunny
                </div>
                <div class="col-sm-12 col-md-6 col-lg-4">
                ...
                <div class="col-sm-12 col-md-6 col-lg-4">
                  <i class="typcn typcn-weather-windy"></i> typcn
                  typcn-weather-windy
                </div>
                <div class="col-sm-12 col-md-6 col-lg-4">
                  <i class="typcn typcn-wi-fi-outline"></i> typcn
                  typcn-wi-fi-outline
                </div>
                <div class="col-sm-12 col-md-6 col-lg-4">
                ...
                <div class="col-sm-12 col-md-6 col-lg-4">
                  <i class="typcn typcn-world-outline"></i> typcn
                  typcn-world-outline
                </div>
                <div class="col-sm-12 col-md-6 col-lg-4">
                ...
                <div class="col-sm-12 col-md-6 col-lg-4">
                  <i class="typcn typcn-zoom-in-outline"></i> typcn
                ...
                <div class="col-sm-12 col-md-6 col-lg-4">
                  <i class="typcn typcn-zoom-out-outline"></i> typcn
                ...
                <div class="col-sm-12 col-md-6 col-lg-4">
                  <i class="typcn typcn-zoom-outline"></i> typcn
                  typcn-zoom-outline
                </div>
                <div class="col-sm-12 col-md-6 col-lg-4">
