        ...
        <div className="container">
          <div className="row">
            <div className="col-md-12">
              <nav className="navbar navbar-expand-lg">
                <a className="navbar-brand" href="!#" onClick={event => event.preventDefault()}><img src= "/images/logo.png" alt="logo" width={170}/></a>
          ...
          <div className="row py-sm-5 py-0">
            <div className="col-lg-7 banner-content">
              ...
              <h3 className="fw-light text-white pt-2 pb-5"> Star Admin Template </h3>
              <div className="my-5">
        ...
        <div className="container">
          <div className="row">
            <div className="col-sm-4 pb-3">
              <div className="card card-icon-top">
                <div className="card-body text-center">
                  <img src= "/images/samples/bootstrap-stack.png" alt="sample" className="card-icon" />
                  <h4>Bootstrap 5</h4>
            ...
            <div className="col-sm-4 pb-3">
              <div className="card card-icon-top">
                <div className="card-body text-center">
                  <img src= "/images/samples/angular-4.png"alt="sample" className="card-icon" />
                  <h4>Angular 5</h4>
            ...
            <div className="col-sm-4 pb-3">
              <div className="card card-icon-top">
                <div className="card-body text-center">
                  <img src= "/images/samples/html5.png" alt="sample" className="card-icon" />
                  <h4>Static HTML</h4>
          ...
          <div className="row mt-5 mb-5">
            <div className="col-md-8 mx-auto py-5 text-center">
              ...
              <h4 className="fw-light"> This template comes with AngularJs and HTML5/jQuery version, which helps to choose the best dashboard solution to fit your project needs. </h4>
            </div>
          </div>
          <div className="row mb-5">
            <div className="col-md-4 grid-margin">
              <div className="m-3">
                <div className="card card-item-preview">
                  <img className="card-img-top" src= "/images/samples/dashboard.jpg" alt="sample" />
                  <div className="card-body py-3 border-top">
                    <label className="badge badge-warning">New</label>
                    <h3 className="fw-normal mb-0 text-center">Dashboard</h3>
                  </div>
                </div>
              </div>
            </div>
            <div className="col-md-4 grid-margin">
              <div className="m-3">
                <div className="card card-item-preview">
                  <img className="card-img-top" src= "/images/samples/widgets.jpg" alt="sapmle" />
                  <div className="card-body py-3 border-top">
                    <h3 className="fw-normal mb-0 text-center">Widgets</h3>
                  </div>
                </div>
              </div>
            </div>
            <div className="col-md-4 grid-margin">
              <div className="m-3">
                <div className="card card-item-preview">
                  <img className="card-img-top" src= "/images/samples/modal.jpg" alt="demo" />
                  <div className="card-body py-3 border-top">
                    <h3 className="fw-normal mb-0 text-center">Modals</h3>
                  </div>
                </div>
              </div>
            </div>
            <div className="col-md-4 grid-margin">
              <div className="m-3">
                <div className="card card-item-preview">
                  <img className="card-img-top" src= "/images/samples/e-commerce.jpg" alt="demo" />
                  <div className="card-body py-3 border-top">
                    <h3 className="fw-normal mb-0 text-center">E-commerce</h3>
                  </div>
                </div>
              </div>
            </div>
            <div className="col-md-4 grid-margin">
              <div className="m-3">
                <div className="card card-item-preview">
                  <img className="card-img-top" src= "/images/samples/email.jpg" alt="demo" />
                  <div className="card-body py-3 border-top">
                    <h3 className="fw-normal mb-0 text-center">Email</h3>
                  </div>
                </div>
              </div>
            </div>
            <div className="col-md-4 grid-margin">
              <div className="m-3">
                <div className="card card-item-preview">
                  <img className="card-img-top" src= "/images/samples/charts.jpg" alt="demo" />
                  <div className="card-body py-3 border-top">
                    <label className="badge badge-success">New</label>
                    <h3 className="fw-normal mb-0 text-center">Charts</h3>
                  </div>
                </div>
              </div>
            </div>
            <div className="col-md-4 grid-margin">
              <div className="m-3">
                <div className="card card-item-preview">
                  <img className="card-img-top" src= "/images/samples/editors.jpg" alt="demo" />
                  <div className="card-body py-3 border-top">
                    <h3 className="fw-normal mb-0 text-center">Code-Editors</h3>
                  </div>
                </div>
              </div>
            </div>
            <div className="col-md-4 grid-margin">
              <div className="m-3">
                <div className="card card-item-preview">
                  <img className="card-img-top" src= "/images/samples/forms.jpg" alt="demo" />
                  <div className="card-body py-3 border-top">
                    <label className="badge badge-info">New</label>
                    <h3 className="fw-normal mb-0 text-center">Forms</h3>
                  </div>
                </div>
              </div>
            </div>
            <div className="col-md-4 grid-margin">
              <div className="m-3">
                <div className="card card-item-preview">
                  <img className="card-img-top" src= "/images/samples/popup.jpg" alt="demo" />
                  <div className="card-body py-3 border-top">
                    <h3 className="fw-normal mb-0 text-center">Popups</h3>
                  </div>
                </div>
              </div>
            </div>
            ...
            <div className="feature-list pt-5">
              <div className="row feature-list-row text-center border-bottom">
                ...
                <div className="col-lg-3 feature-list-item border-right">
                  ...
                  <h3>Bootstrap 5</h3>
                  <p className="feature-description">It is made with bootstrap 5 framework</p>
                </div>
                <div className="col-lg-3 feature-list-item border-right">
            ...
            <div className="row">
              <div className="col-lg-4">
                ...
                <div className="d-flex pt-5 pb-5">
                  ...
                  <div className="social-icons bg-danger text-white"><span className="mdi mdi-pinterest"></span></div>
              ...
              <div className="col-lg-5">
                <div className="d-flex">
                  ...
                  <h6 className="fw-normal">(0000) 1234 5678</h6>
                </div>
                <div className="d-flex">
                  <i className="mdi mdi-cog"></i>
                  <h6 className="fw-normal">support@staradmin.org</h6>
                </div>
                <ul className="nav mt-3">
                  <li className="nav-item">
                    <a className="nav-link ps-0" href="!#" onClick={event => event.preventDefault()}>Demos</a>
                  </li>
                  <li className="nav-item">
