import {
  ...
  shift,
  useFloating
} from "./chunk-QACBN2JR.js";
import {
  autoUpdate
} from "./chunk-77TATWCX.js";
import {
  TransitionGroup_default
} from "./chunk-2KSQYI5P.js";
import {
  createPopper
} from "./chunk-3C5H7FU3.js";
import {
  Transition_default
} from "./chunk-AOV5TQUW.js";
...
} from "./chunk-UQZUDIPJ.js";
import {
  keyframes
} from "./chunk-WZGYVSGG.js";
import {
  clsx_default
...
function Ripple(props) {
  ...
  const [leaving, setLeaving] = React77.useState(false);
...
var TouchRipple = React78.forwardRef(function TouchRipple2(inProps, ref) {
  const props = useDefaultProps2({
    props: inProps,
    name: "MuiTouchRipple"
  });
  ...
  const [ripples, setRipples] = React78.useState([]);
  const nextKey = React78.useRef(0);
  const rippleCallback = React78.useRef(null);
  React78.useEffect(() => {
  ...
  const ignoringMouseDown = React78.useRef(false);
  const startTimer = useTimeout();
  const startTimerCommit = React78.useRef(null);
  const container = React78.useRef(null);
  const startCommit = React78.useCallback((params) => {
    const {
      pulsate: pulsate2,
      rippleX,
      rippleY,
    ...
    setRipples((oldRipples) => [...oldRipples, (0, import_jsx_runtime54.jsx)(TouchRippleRipple, {
      classes: {
  ...
  const start = React78.useCallback((event = {}, options = {}, cb = () => {
  }) => {
    const {
  ...
  const pulsate = React78.useCallback(() => {
    start({}, {
      pulsate: true
    });
  }, [start]);
  const stop = React78.useCallback((event, cb) => {
    startTimer.clear();
  ...
  return (0, import_jsx_runtime54.jsx)(TouchRippleRoot, _extends({
    className: clsx_default(touchRippleClasses_default.root, classes.root, className),
    ref: container
  }, other, {
    children: (0, import_jsx_runtime54.jsx)(TransitionGroup_default, {
      component: null,
      exit: true,
      children: ripples
    })
...
var ButtonBase = React79.forwardRef(function ButtonBase2(inProps, ref) {
  const props = useDefaultProps2({
    props: inProps,
    name: "MuiButtonBase"
  });
  ...
  return (0, import_jsx_runtime56.jsxs)(ButtonBaseRoot, _extends({
    as: ComponentProp,
    className: clsx_default(classes.root, className),
    ownerState,
    onBlur: handleBlur2,
    ...
    children: [children, enableTouchRipple ? (
      ...
      (0, import_jsx_runtime55.jsx)(TouchRipple_default, _extends({
        ref: handleRippleRef,
        center: centerRipple
      }, TouchRippleProps))
    ) : null]
...
var SwitchBase = React80.forwardRef(function SwitchBase2(props, ref) {
  const {
    autoFocus,
    checked: checkedProp,
    checkedIcon,
...
var Checkbox = React84.forwardRef(function Checkbox2(inProps, ref) {
  ...
  return (0, import_jsx_runtime62.jsx)(CheckboxRoot, _extends({
    ...
    checkedIcon: React84.cloneElement(indeterminateIcon, {
...
var _excluded34 = ["classes", "className", "displayIcon", "expansionIcon", "icon", "label", "itemId", "onClick", "onMouseDown"];
var TreeItemContent = React85.forwardRef(function TreeItemContent2(props, ref) {
  const {
    classes,
    className,
    displayIcon,
  ...
  const checkboxRef = React85.useRef(null);
  ...
  return (
    ...
    (0, import_jsx_runtime63.jsxs)("div", _extends({}, other, {
      ...
      children: [(0, import_jsx_runtime63.jsx)("div", {
        ...
        children: icon
      }), checkboxSelection && (0, import_jsx_runtime63.jsx)(Checkbox_default, {
...
true ? TreeItemContent.propTypes = {
   ...
   */
  displayIcon: import_prop_types39.default.node,
  /**
   * The icon to display next to the tree item's label. Either an expansion or collapse icon.
   */
  expansionIcon: import_prop_types39.default.node,
  /**
   ...
   * The id of the item.
   */
  itemId: import_prop_types39.default.string.isRequired,
  /**
   * The tree item label.
   */
...
var TreeViewExpandIcon = createSvgIcon((0, import_jsx_runtime64.jsx)("path", {
  d: "M10 6 8.59 7.41 13.17 12l-4.58 4.59L10 18l6-6z"
}), "TreeViewExpandIcon");
var TreeViewCollapseIcon = createSvgIcon((0, import_jsx_runtime64.jsx)("path", {
...
TreeItem2Provider.propTypes = {
  ...
  itemId: import_prop_types40.default.string.isRequired
};

// node_modules/@mui/x-tree-view/TreeItem/TreeItem.js
var import_jsx_runtime65 = __toESM(require_jsx_runtime());
var _excluded35 = ["children", "className", "slots", "slotProps", "ContentComponent", "ContentProps", "itemId", "id", "label", "onClick", "onMouseDown", "onFocus", "onBlur", "onKeyDown"];
...
var TreeItem = React87.forwardRef(function TreeItem2(inProps, inRef) {
  const {
    icons: contextIcons,
    runItemPlugins,
    selection: {
  ...
  const depthContext = React87.useContext(TreeViewItemDepthContext);
  ...
  }), expansionIconProps = _objectWithoutPropertiesLoose(_useSlotProps, _excluded210);
  const expansionIcon = expandable && !!ExpansionIcon ? (0, import_jsx_runtime65.jsx)(ExpansionIcon, _extends({}, expansionIconProps)) : null;
  ...
  }), displayIconProps = _objectWithoutPropertiesLoose(_useSlotProps2, _excluded36);
  const displayIcon = DisplayIcon ? (0, import_jsx_runtime65.jsx)(DisplayIcon, _extends({}, displayIconProps)) : null;
  ...
  const icon = Icon ? (0, import_jsx_runtime65.jsx)(Icon, _extends({}, iconProps)) : null;
  let ariaSelected;
  if (multiSelect) {
  ...
  return (0, import_jsx_runtime65.jsx)(TreeItem2Provider, {
    itemId,
    children: (0, import_jsx_runtime65.jsxs)(TreeItemRoot, _extends({
      className: clsx_default(classes.root, className),
      role: "treeitem",
      ...
      children: [(0, import_jsx_runtime65.jsx)(StyledTreeItemContent, _extends({
        as: ContentComponent,
        classes: {
      ...
      })), children && (0, import_jsx_runtime65.jsx)(TreeItemGroup, _extends({
        as: GroupTransition
...
true ? TreeItem.propTypes = {
   ...
   * The id of the item.
   */
  itemId: import_prop_types41.default.string.isRequired,
  /**
   * The tree item label.
   */
