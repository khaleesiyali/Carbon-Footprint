import {
  ...
  forEach,
  map
} from "./chunk-HR2F5JJA.js";
import {
  Col_default,
  useCol
} from "./chunk-FQE5GLZW.js";
import {
  Row_default
} from "./chunk-DLO2HDOV.js";
import {
...
import {
  ...
  Button_default2,
  useButtonProps
} from "./chunk-4XFISZAZ.js";
import {
  Table_default
} from "./chunk-SCITT2NT.js";
import {
  InputGroupContext_default,
  InputGroup_default
} from "./chunk-IVR7DKIT.js";
import {
  createWithBsPrefix
} from "./chunk-WVDHRHXH.js";
import {
  DEFAULT_BREAKPOINTS,
...
function getReactVersion() {
  const parts = React50.version.split(".");
  return {
    major: +parts[0],
    minor: +parts[1],
    patch: +parts[2]
...
var Modal = (0, import_react48.forwardRef)((_ref, ref) => {
  ...
  return (0, import_jsx_runtime48.jsx)(import_jsx_runtime49.Fragment, {
    children: import_react_dom2.default.createPortal((0, import_jsx_runtime50.jsxs)(import_jsx_runtime49.Fragment, {
...
var Modal2 = React58.forwardRef(({
  ...
  const renderBackdrop = (0, import_react50.useCallback)((backdropProps) => (0, import_jsx_runtime55.jsx)("div", {
    ...backdropProps,
...
var Offcanvas = React66.forwardRef(({
  ...
  const renderDialog = (dialogProps) => (0, import_jsx_runtime63.jsx)("div", {
    ...
    ...dialogProps,
    ...props,
    className: (0, import_classnames40.default)(className, bsPrefix, `${bsPrefix}-${placement}`),
    "aria-labelledby": ariaLabelledby,
    children
  });
...
var NavbarOffcanvas = React67.forwardRef(({
  ...
  return hasExpandProp && shouldExpand ? (0, import_jsx_runtime64.jsx)("div", {
    ref,
    ...props,
    className: (0, import_classnames41.default)(className, bsPrefix, `${bsPrefix}-${placement}`)
  }) : (0, import_jsx_runtime64.jsx)(Offcanvas_default, {
    ref,
...
function OverlayTrigger({
  ...
  return (0, import_jsx_runtime73.jsxs)(import_jsx_runtime72.Fragment, {
    children: [typeof children === "function" ? children(triggerProps) : (0, import_react63.cloneElement)(children, triggerProps), (0, import_jsx_runtime71.jsx)(Overlay_default2, {
      ...props,
      show,
      onHide: handleHide,
      flip,
...
var ToastFade = React90.forwardRef((props, ref) => (0, import_jsx_runtime93.jsx)(Fade_default, {
  ...props,
  ref,
