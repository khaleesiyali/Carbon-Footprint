        ...
        <div className="col-md-6 grid-margin stretch-card">
          <div className="card">
            <div className="card-body">
              ...
              <p className="card-description"> Wrap content inside<code>&lt;blockquote className=&quote;blockquote&quote;&gt;</code>
              </p>
            ...
            <div className="card-body">
              <blockquote className="blockquote blockquote-primary">
                ...
                <div className="blockquote-footer">Someone famous in <cite title="Source Title">Source Title</cite></div>
              </blockquote>
            </div>
          </div>
        </div>
            ...
            <div className="card-body">
              ...
              <div className="row">
                <div className="col-md-6">
                  <address>
                    <p className="fw-bold">Purple imc</p>
                    <p> 695 lsom Ave, </p>
                    <p> Suite 00 </p>
