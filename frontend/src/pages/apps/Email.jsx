          ...
          <div className="mail-sidebar d-none d-lg-block col-xl-2 pt-3">
            <div className="menu-bar">
              <ul className="menu-items">
                <li className="compose mb-3 d-grid gap-2"><Button variant="btn btn-primary">Compose</Button></li>
              ...
              <ul className="profile-list">
                <li className="profile-list-item"> <a href="!#" onClick={evt =>evt.preventDefault()}> <span className="pro-pic">
                  <img src="/images/faces/face1.jpg" alt="user"/>
                  </span><div className="user"><p className="u-name">David</p><p className="u-designation">Python Developer</p></div> </a></li>
                <li className="profile-list-item"> <a href="!#" onClick={evt =>evt.preventDefault()}> <span className="pro-pic">
                  <img src="/images/faces/face2.jpg" alt="user"/>
                  </span><div className="user"><p className="u-name">Stella Johnson</p><p className="u-designation">SEO Expert</p></div> </a></li>
                <li className="profile-list-item"> <a href="!#" onClick={evt =>evt.preventDefault()}> <span className="pro-pic">
                  <img src="/images/faces/face20.jpg" alt="user"/>
                  </span><div className="user"><p className="u-name">Catherine</p><p className="u-designation">IOS Developer</p></div> </a></li>
                <li className="profile-list-item"> <a href="!#" onClick={evt =>evt.preventDefault()}> <span className="pro-pic">
                  <img src="/images/faces/face12.jpg" alt="user"/>
                  </span><div className="user"><p className="u-name">John Doe</p><p className="u-designation">Business Analyst</p></div> </a></li>
                <li className="profile-list-item"> <a href="!#" onClick={evt =>evt.preventDefault()}> <span className="pro-pic">
                  <img src="/images/faces/face25.jpg" alt="user"/>
                  </span><div className="user"><p className="u-name">Daniel Russell</p><p className="u-designation">Tester</p></div> </a></li>
                <li className="profile-list-item"> <a href="!#" onClick={evt =>evt.preventDefault()}> <span className="pro-pic">
                  <img src="/images/faces/face10.jpg" alt="user"/>
                  </span><div className="user"><p className="u-name">Sarah Graves</p><p className="u-designation">Admin</p></div> </a></li>
                <li className="profile-list-item"> <a href="!#" onClick={evt =>evt.preventDefault()}> <span className="pro-pic">
                  <img src="/images/faces/face23.jpg" alt="user"/>
                  </span><div className="user"><p className="u-name">Sophia Lara</p><p className="u-designation">UI/UX</p></div> </a></li>
                <li className="profile-list-item"> <a href="!#" onClick={evt =>evt.preventDefault()}> <span className="pro-pic">
                  <img src="/images/faces/face11.jpg" alt="user"/>
                  </span><div className="user"><p className="u-name">Catherine Myers</p><p className="u-designation">Business Analyst</p></div> </a></li>
                <li className="profile-list-item"> <a href="!#" onClick={evt =>evt.preventDefault()}> <span className="pro-pic">
                  <img src="/images/faces/face9.jpg" alt="user"/>
                  </span><div className="user"><p className="u-name">Tim</p><p className="u-designation">PHP Developer</p></div> </a></li>
              </ul>
            </div>
          </div>
          ...
          <div className="mail-view d-none d-md-block col-xl-7">
              ...
              <div className="col-md-12 mb-4 mt-4">
                <div className="btn-toolbar">
                  <div className="btn-group">
                    <Button type="button" variant="btn btn-sm btn-outline-secondary"><i className="mdi mdi-share text-primary me-1"></i> Reply</Button>
                    <Button type="button" variant="btn btn-sm btn-outline-secondary"><i className="mdi mdi-share-all text-primary me-1"></i>Reply All</Button>
                    <Button type="button" variant="btn btn-sm btn-outline-secondary"><i className="mdi mdi-share text-primary me-1"></i>Forward</Button>
                  </div>
                  <div className="btn-group">
                    <Button type="button" variant="btn btn-sm btn-outline-secondary"><i className="mdi mdi-attachment text-primary me-1"></i>Attach</Button>
                    <Button type="button" variant="btn btn-sm btn-outline-secondary"><i className="mdi mdi-delete text-primary me-1"></i>Delete</Button>
                  </div>
                </div>
              </div>
            </div>
            <div className="message-body">
              <div className="sender-details">
                <img className="img-sm rounded-circle me-3" src="/images/faces/face11.jpg" alt="user"/>
                <div className="details">
              ...
              <div className="attachments-sections">
                <ul>
                  <li>
                    <div className="thumb"><i className="mdi mdi-file-pdf-box"></i></div>
                    <div className="details">
                      <p className="file-name text-light">Seminar Reports.pdf</p>
                  ...
                  <li>
                    ...
                    <div className="details">
                      <p className="file-name text-light">Product Design.jpg</p>
                      <div className="buttons">
