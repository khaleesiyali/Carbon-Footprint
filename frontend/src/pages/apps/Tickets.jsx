import {Form, Col, Row, Nav, Tab, Button} from 'react-bootstrap'
            ...
            <div className="card-body">
              <div className="d-sm-flex pb-4 mb-4 border-bottom">
                <div className="d-flex align-items-center">
                  <h5 className="page-title mb-2">Open Tickets</h5>
                  <p className="mt-2 ms-3 text-muted">230 Tickets</p>
                </div>
                <form className='ms-lg-auto d-flex pt-2 pt-md-0 align-items-center justify-content-end'>
                  <Form.Control type="text" className="h-auto w-50 me-4 mb-2" placeholder="Search" />
                  <Button type="submit" variant="btn btn-gradient-success no-wrap ms-lg-4 ms-0 px-2 px-lg-4">Search Tickets</Button>
                </form>
              </div>
                        ...
                        <Tab.Pane eventKey="first">
                          <div>
                            ...
                            <a href="!#" className="tickets-card row mx-0" onClick={evt =>evt.preventDefault()}>
                              ...
                              <div className="ticket-float col-lg-3 col-sm-6 d-none d-md-block pe-0">
                            ...
                            <a href="!#" className="tickets-card row mx-0" onClick={evt =>evt.preventDefault()}>
                              ...
                              <div className="ticket-float col-lg-3 col-12  pe-0">
                            ...
                            <a href="!#" className="tickets-card row mx-0" onClick={evt =>evt.preventDefault()}>
                              ...
                              <div className="ticket-float col-lg-3 col-sm-6  pe-0">
