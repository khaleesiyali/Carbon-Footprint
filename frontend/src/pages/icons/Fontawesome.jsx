  ...
  return (
    <div>
      <div className="page-header">
        <h3 className="page-title">Font awesome</h3>
          ...
          <div className="card">
            <div className="card-body">
              ...
              <div className="icons-list row">
                ...
                {/* <div className="col-sm-6 col-md-4 col-lg-3">
                  {" "}
                  <i className="fa-regular fa-address-book-o"></i>fa fa-address-book-o{" "}
                </div> */}
                <div className="col-sm-6 col-md-4 col-lg-3">
                  {" "}
        ...
        <div className="col-lg-12 grid-margin">
          <div className="card">
            <div className="card-body">
              ...
              <div className="row icons-list">
                <div className="col-sm-6 col-md-4 col-lg-3">
                  <i className="fab fa-adn"></i> fa-adn
                </div>
                <div className="col-sm-6 col-md-4 col-lg-3">
                  <i className="fab fa-android"></i> fa-android
                </div>
                <div className="col-sm-6 col-md-4 col-lg-3">
                  <i className="fab fa-apple"></i> fa-apple
                </div>
                <div className="col-sm-6 col-md-4 col-lg-3">
                  <i className="fab fa-behance"></i> fa-behance
                </div>
                <div className="col-sm-6 col-md-4 col-lg-3">
                  <i className="fab fa-behance-square"></i> fa-behance-square
                </div>
                <div className="col-sm-6 col-md-4 col-lg-3">
                  <i className="fab fa-bitbucket"></i> fa-bitbucket
                </div>
                {/* <div className="col-sm-6 col-md-4 col-lg-3">
                  <i className="fab fa-bitbucket-square"></i>{" "}
                  fa-bitbucket-square
                </div> */}
                <div className="col-sm-6 col-md-4 col-lg-3">
                  <i className="fab fa-bitcoin"></i> fa-bitcoin{" "}
                  <span className="text-muted">(alias)</span>{" "}
                </div>
                <div className="col-sm-6 col-md-4 col-lg-3">
                  <i className="fab fa-btc"></i> fa-btc
                </div>
                <div className="col-sm-6 col-md-4 col-lg-3">
                  <i className="fab fa-codepen"></i> fa-codepen
                </div>
                <div className="col-sm-6 col-md-4 col-lg-3">
                  <i className="fab fa-css3"></i> fa-css3
                </div>
                <div className="col-sm-6 col-md-4 col-lg-3">
                  <i className="fab fa-delicious"></i> fa-delicious
                </div>
                <div className="col-sm-6 col-md-4 col-lg-3">
                  <i className="fab fa-deviantart"></i> fa-deviantart
                </div>
                <div className="col-sm-6 col-md-4 col-lg-3">
                  <i className="fab fa-digg"></i> fa-digg
                </div>
                <div className="col-sm-6 col-md-4 col-lg-3">
                  <i className="fab fa-dribbble"></i> fa-dribbble
                </div>
                <div className="col-sm-6 col-md-4 col-lg-3">
                  <i className="fab fa-dropbox"></i> fa-dropbox
                </div>
                <div className="col-sm-6 col-md-4 col-lg-3">
                  <i className="fab fa-drupal"></i> fa-drupal
                </div>
                <div className="col-sm-6 col-md-4 col-lg-3">
                  <i className="fab fa-empire"></i> fa-empire
                </div>
                <div className="col-sm-6 col-md-4 col-lg-3">
                  <i className="fab fa-facebook"></i> fa-facebook
                </div>
                <div className="col-sm-6 col-md-4 col-lg-3">
                  <i className="fab fa-facebook-square"></i> fa-facebook-square
                </div>
                <div className="col-sm-6 col-md-4 col-lg-3">
                  <i className="fab fa-flickr"></i> fa-flickr
                </div>
                <div className="col-sm-6 col-md-4 col-lg-3">
                  <i className="fab fa-foursquare"></i> fa-foursquare
                </div>
                {/* <div className="col-sm-6 col-md-4 col-lg-3">
                  <i className="fab fa-ge"></i> fa-ge{" "}
                  <span className="text-muted">(alias)</span>{" "}
                </div> */}
                <div className="col-sm-6 col-md-4 col-lg-3">
                  <i className="fab fa-git"></i> fa-git
                </div>
                <div className="col-sm-6 col-md-4 col-lg-3">
                  <i className="fab fa-git-square"></i> fa-git-square
                </div>
                <div className="col-sm-6 col-md-4 col-lg-3">
                  <i className="fab fa-github"></i> fa-github
                </div>
                <div className="col-sm-6 col-md-4 col-lg-3">
                  <i className="fab fa-github-alt"></i> fa-github-alt
                </div>
                <div className="col-sm-6 col-md-4 col-lg-3">
                  <i className="fab fa-github-square"></i> fa-github-square
                </div>
                {/* <div className="col-sm-6 col-md-4 col-lg-3">
                  <i className="fab fa-gittip"></i> fa-gittip
                </div> */}
                <div className="col-sm-6 col-md-4 col-lg-3">
                  <i className="fab fa-google"></i> fa-google
                </div>
                <div className="col-sm-6 col-md-4 col-lg-3">
                  <i className="fab fa-google-plus"></i> fa-google-plus
                </div>
                <div className="col-sm-6 col-md-4 col-lg-3">
                ...
                <div className="col-sm-6 col-md-4 col-lg-3">
                  <i className="fab fa-hacker-news"></i> fa-hacker-news
                </div>
                <div className="col-sm-6 col-md-4 col-lg-3">
                  <i className="fab fa-html5"></i> fa-html5
                </div>
                <div className="col-sm-6 col-md-4 col-lg-3">
                  <i className="fab fa-instagram"></i> fa-instagram
                </div>
                <div className="col-sm-6 col-md-4 col-lg-3">
                  <i className="fab fa-joomla"></i> fa-joomla
                </div>
                <div className="col-sm-6 col-md-4 col-lg-3">
                  <i className="fab fa-jsfiddle"></i> fa-jsfiddle
                </div>
                <div className="col-sm-6 col-md-4 col-lg-3">
                  <i className="fab fa-linkedin"></i> fa-linkedin
                </div>
                {/* <div className="col-sm-6 col-md-4 col-lg-3">
                  <i className="fab fa-linkedin-square"></i> fa-linkedin-square
                </div> */}
                <div className="col-sm-6 col-md-4 col-lg-3">
                  <i className="fab fa-linux"></i> fa-linux
                </div>
                <div className="col-sm-6 col-md-4 col-lg-3">
                  <i className="fab fa-maxcdn"></i> fa-maxcdn
                </div>
                <div className="col-sm-6 col-md-4 col-lg-3">
                  <i className="fab fa-openid"></i> fa-openid
                </div>
                <div className="col-sm-6 col-md-4 col-lg-3">
                  <i className="fab fa-pagelines"></i> fa-pagelines
                </div>
                <div className="col-sm-6 col-md-4 col-lg-3">
                  <i className="fab fa-pied-piper"></i> fa-pied-piper
                </div>
                <div className="col-sm-6 col-md-4 col-lg-3">
                  <i className="fab fa-pied-piper-alt"></i> fa-pied-piper-alt
                </div>
                <div className="col-sm-6 col-md-4 col-lg-3">
                  <i className="fab fa-pinterest"></i> fa-pinterest
                </div>
                <div className="col-sm-6 col-md-4 col-lg-3">
                ...
                <div className="col-sm-6 col-md-4 col-lg-3">
                  <i className="fab fa-qq"></i> fa-qq
                </div>
                {/* <div className="col-sm-6 col-md-4 col-lg-3">
                  <i className="fab fa-ra"></i> fa-ra{" "}
                  <span className="text-muted">(alias)</span>{" "}
                </div> */}
                <div className="col-sm-6 col-md-4 col-lg-3">
                  <i className="fab fa-rebel"></i> fa-rebel
                </div>
                <div className="col-sm-6 col-md-4 col-lg-3">
                  <i className="fab fa-reddit"></i> fa-reddit
                </div>
                <div className="col-sm-6 col-md-4 col-lg-3">
                  <i className="fab fa-reddit-square"></i> fa-reddit-square
                </div>
                <div className="col-sm-6 col-md-4 col-lg-3">
                  <i className="fab fa-renren"></i> fa-renren
                </div>
                <div className="col-sm-6 col-md-4 col-lg-3">
                  <i className="fab fa-share-alt"></i> fa-share-alt
                </div>
                <div className="col-sm-6 col-md-4 col-lg-3">
                  <i className="fab fa-share-alt-square"></i>{" "}
                  fa-share-alt-square
                </div>
                <div className="col-sm-6 col-md-4 col-lg-3">
                  <i className="fab fa-skype"></i> fa-skype
                </div>
                <div className="col-sm-6 col-md-4 col-lg-3">
                  <i className="fab fa-slack"></i> fa-slack
                </div>
                <div className="col-sm-6 col-md-4 col-lg-3">
                  <i className="fab fa-soundcloud"></i> fa-soundcloud
                </div>
                <div className="col-sm-6 col-md-4 col-lg-3">
                  <i className="fab fa-spotify"></i> fa-spotify
                </div>
                <div className="col-sm-6 col-md-4 col-lg-3">
                  <i className="fab fa-stack-exchange"></i> fa-stack-exchange
                </div>
                <div className="col-sm-6 col-md-4 col-lg-3">
                  <i className="fab fa-stack-overflow"></i> fa-stack-overflow
                </div>
                <div className="col-sm-6 col-md-4 col-lg-3">
                  <i className="fab fa-steam"></i> fa-steam
                </div>
                <div className="col-sm-6 col-md-4 col-lg-3">
                  <i className="fab fa-steam-square"></i> fa-steam-square
                </div>
                <div className="col-sm-6 col-md-4 col-lg-3">
                  <i className="fab fa-stumbleupon"></i> fa-stumbleupon
                </div>
                <div className="col-sm-6 col-md-4 col-lg-3">
                ...
                <div className="col-sm-6 col-md-4 col-lg-3">
                  <i className="fab fa-tencent-weibo"></i> fa-tencent-weibo
                </div>
                <div className="col-sm-6 col-md-4 col-lg-3">
                  <i className="fab fa-trello"></i> fa-trello
                </div>
                <div className="col-sm-6 col-md-4 col-lg-3">
                  <i className="fab fa-tumblr"></i> fa-tumblr
                </div>
                <div className="col-sm-6 col-md-4 col-lg-3">
                  <i className="fab fa-tumblr-square"></i> fa-tumblr-square
                </div>
                <div className="col-sm-6 col-md-4 col-lg-3">
                  <i className="fab fa-twitter"></i> fa-twitter
                </div>
                <div className="col-sm-6 col-md-4 col-lg-3">
                  <i className="fab fa-twitter-square"></i> fa-twitter-square
                </div>
                <div className="col-sm-6 col-md-4 col-lg-3">
                  <i className="fab fa-vimeo-square"></i> fa-vimeo-square
                </div>
                <div className="col-sm-6 col-md-4 col-lg-3">
                  <i className="fab fa-vine"></i> fa-vine
                </div>
                <div className="col-sm-6 col-md-4 col-lg-3">
                  <i className="fab fa-vk"></i> fa-vk
                </div>
                {/* <div className="col-sm-6 col-md-4 col-lg-3">
                  <i className="fab fa-wechat"></i> fa-wechat{" "}
                  <span className="text-muted">(alias)</span>{" "}
                </div> */}
                <div className="col-sm-6 col-md-4 col-lg-3">
                  <i className="fab fa-weibo"></i> fa-weibo
                </div>
                <div className="col-sm-6 col-md-4 col-lg-3">
                  <i className="fab fa-weixin"></i> fa-weixin
                </div>
                <div className="col-sm-6 col-md-4 col-lg-3">
                  <i className="fab fa-windows"></i> fa-windows
                </div>
                <div className="col-sm-6 col-md-4 col-lg-3">
                  <i className="fab fa-wordpress"></i> fa-wordpress
                </div>
                <div className="col-sm-6 col-md-4 col-lg-3">
                  <i className="fab fa-xing"></i> fa-xing
                </div>
                <div className="col-sm-6 col-md-4 col-lg-3">
                  <i className="fab fa-xing-square"></i> fa-xing-square
                </div>
                <div className="col-sm-6 col-md-4 col-lg-3">
                  <i className="fab fa-yahoo"></i> fa-yahoo
                </div>
                <div className="col-sm-6 col-md-4 col-lg-3">
                  <i className="fab fa-youtube"></i> fa-youtube
                </div>
                {/* <div className="col-sm-6 col-md-4 col-lg-3">
                  <i className="fab fa-youtube-play"></i> fa-youtube-play
                </div> */}
                <div className="col-sm-6 col-md-4 col-lg-3">
                  <i className="fab fa-youtube-square"></i> fa-youtube-square
                </div>
              </div>
            </div>
          </div>
