  ...
  return (
    <div>
      <div className="page-header">
        <h3 className="page-title">Simple line icons</h3>
            ...
            <div className="card-body">
              ...
              <div className="icons-list row">
                ...
                <div className="col-sm-6 col-md-4 col-lg-3">
                  <div className="preview">
                    {" "}
                    <i className="icon-control-forward"></i>{" "}
                ...
                <div className="col-sm-6 col-md-4 col-lg-3">
                  <div className="preview">
                    {" "}
                    <i className="icon-magnifier-remove"></i>{" "}
                ...
                <div className="col-sm-6 col-md-4 col-lg-3">
                  <div className="preview">
                    {" "}
                    <i className="icon-social-google"></i> icon-social-google{" "}
                  </div>
                </div>
                <div className="col-sm-6 col-md-4 col-lg-3">
                  <div className="preview">
                ...
                <div className="col-sm-6 col-md-4 col-lg-3">
                  <div className="preview">
                    {" "}
                    <i className="icon-social-foursqare"></i>{" "}
                ...
                <div className="col-sm-6 col-md-4 col-lg-3">
                  <div className="preview">
                    {" "}
                    <i className="icon-social-stumbleupon"></i>{" "}
